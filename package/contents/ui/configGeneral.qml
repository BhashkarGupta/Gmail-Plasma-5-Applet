...
Kirigami.FormLayout {
    ...
    QQC2.Label {
		font.pixelSize: 12
		text:i18n("When checked pressing Enter will send the email.");
	}
	QQC2.Label {
		font.pixelSize: 8
		font.italic: true
	...
	QQC2.CheckBox {
        ...
        text: i18n("Allow Gmail system clipboard access")
    }
    QQC2.Label {
		font.pixelSize: 8
		font.italic: true
		text:i18n("This is enabled by default to allow for quick email responses but can be disabled if you are worried about Gmail examining your system clipboard");
	}
