    ...
    Plasmoid.fullRepresentation: ColumnLayout {
        ...
        Timer {
            ...
            onTriggered: {
                if (!loadedsuccessfully &&
                    ...
                    root.reloadRetries < root.maxReloadRetries) {
                    console.log("Failed to load Gmail page, reloading as we are hidden..")
                    ...
                    RowLayout {
                        ...
                        RowLayout {
                            ...
                            PlasmaComponents.ToolButton {
                                text: i18n("Back to Gmail")
                                visible: !gptWebView.url.toString().match(/mail\.google\.com\/(.*)/)
                                enabled: visible
                                ...
                                onClicked: gptWebView.url = "https://mail.google.com/"
                            }
        ...
        WebEngineView {
            ...
            onLoadFailed: {
                ...
                // Handle the error, e.g., show an error message or retry loading
            }
            ...
            onNewViewRequested: {
                ...
                if (request.requestedUrl.toString().match(/https?\:\/\/mail\.google\.com/)) {
            ...
            onNavigationRequested: {
                if (request.navigationType == WebEngineNavigationRequest.LinkClickedNavigation) {
                    if (request.url.toString().match(/https?\:\/\/mail\.google\.com/)) {
